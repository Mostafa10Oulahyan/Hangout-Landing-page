            ...
            <div ref={shellRef} className="relative z-[1] group">
                ...
                >
                    ...
                    >
                        ...
                        {/* Name and title at bottom - above user info bar */}
                        <div
                            className="absolute left-0 right-0 z-[5] px-6 flex flex-col items-center text-center"
                            style={{
                                pointerEvents: 'none',
                                bottom: showUserInfo ? '100px' : '24px'
                            }}
                        >
                            <h3 className="text-2xl font-bold text-white mb-1 drop-shadow-lg">{name}</h3>
                            <p className="text-base text-white/90 font-medium drop-shadow-md">{title}</p>
                        </div>

                        {/* User info bar */}
                        {showUserInfo && (
                            <div
                                className="absolute z-[6] flex items-center justify-between backdrop-blur-[30px] border border-white/10"
                                style={{
                                    '--ui-inset': '20px',
                                    '--ui-radius-bias': '6px',
                                    bottom: 'var(--ui-inset)',
